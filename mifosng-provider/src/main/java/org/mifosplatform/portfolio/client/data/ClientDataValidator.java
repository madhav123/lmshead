...
public final class ClientDataValidator {
    ...
    public void validateForCreate(final String json) {
        ...
        //madhav
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.mailIdParamName, element)) {
            final String mailId = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.mailIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.mailIdParamName).value(mailId).ignoreIfNull()
                    .notExceedingLengthOf(50);
        }
