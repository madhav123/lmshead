...
import org.mifosplatform.portfolio.message.data.EnumMessageType;
import org.mifosplatform.portfolio.message.data.MediaEnumoptionData;
import org.mifosplatform.portfolio.message.data.MessageTypeEnumaration;
...
public class BillingMesssageReadPlatformServiceImpl implements
	...
	private static BillingMesssageReadPlatformService billingMesssageReadPlatformService=null;
...
public BillingMessageData mapRow(ResultSet rs, int rowNum)
	...
	try {
		...
		for (int j = 1; j <= Rows; j++) {
			...
			String status = "N";
			String messageFrom = "LMS(Lease Management system";
	...
	public BillingMessageData retrieveTemplate() {
		...
		MediaEnumoptionData email = MessageTypeEnumaration
				.enummessageData(EnumMessageType.EMAIL);
		MediaEnumoptionData message = MessageTypeEnumaration
