...
public class CommandWrapper {
    ...
    public boolean isCreateWithReschedule() {
        return this.actionName.equalsIgnoreCase("CREATEWITHRESCHEDULE");
    }
    ...
    public boolean isUpdateJobParam() {
    	 return this.actionName.equalsIgnoreCase("UPDATEJOBPARAM");
    }
	...
	public boolean isEquityRessource(){
		return this.entityName().equalsIgnoreCase("EQUITY");
	}
