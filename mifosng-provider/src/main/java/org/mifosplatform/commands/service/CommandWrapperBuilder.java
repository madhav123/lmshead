...
public class CommandWrapperBuilder {
    ...
    public CommandWrapperBuilder createLoanApplicationWithReschedule() {
        this.actionName = "CREATEWITHRESCHEDULE";
        this.entityName = "LOAN";
        this.entityId = null;
        this.loanId = null;
        this.href = "/loans";
    ...
    public CommandWrapperBuilder createEquity(Long loanId) {
        this.actionName = "CREATE";
        this.entityName = "EQUITY";
        this.entityId = loanId;
        this.href = "/equitys/template";
        return this;
    }
    ...
    public CommandWrapperBuilder updateJobParametersDetail(Long jobId) {
	     this.actionName = "UPDATEJOBPARAM";
	    this.entityName = "SCHEDULER";
	    this.entityId = jobId;
	...
	public CommandWrapperBuilder createMessageData(Long messageId) {
	...
	public CommandWrapperBuilder updateMessageData(Long messageId) {
		this.actionName = "UPDATE";
		this.entityName = "BILLINGMESSAGE";
		this.entityId = clientId;
		this.href = "/billingMessage/"+entityId;
